...
export const siteConfig: SiteConfig = {
	title: "jason's blog",
	subtitle: "never give it up",
	siteURL: "https://mizuki.mysqil.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-05-01", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "2092181443", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/Image_1777873761615_570.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "jasonff",
	bio: " “人们所说的永远，仅仅是形容当下的炽热”",
	typewriter: {
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/2092181443",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
		...
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/jason195421",
		},
		{
			name: "Codeberg",
